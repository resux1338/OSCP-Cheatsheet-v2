...
| Several TCP services | Can you run an SSH client or Chisel on the foothold? Test one known port through SOCKS. | [SSH and Socat](pivoting/ssh-socat.md) · [Chisel](pivoting/chisel-ligolo.md) · [Cross-compile Chisel](pivoting/chisel-ligolo.md#cross-compile-chisel) |
